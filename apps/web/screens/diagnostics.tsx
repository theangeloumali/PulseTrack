...
export default function DiagnosticsPage() {
	...
	const [testResults, setTestResults] = useState<Record<string, { status: string; message: string; details?: any }>>({});
	const [detailedResults, setDetailedResults] = useState<{ test: string; success: boolean; data?: any; error?: any; timestamp: string; }[]>([]);
