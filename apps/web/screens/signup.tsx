  ...
  return (
    <div className="flex min-h-screen bg-background text-foreground overflow-hidden selection:bg-primary/20 selection:text-primary">
      ...
      <div className="hidden lg:flex w-5/12 bg-muted relative items-center justify-center p-12 border-r border-border overflow-hidden">
        ...
        >
          <motion.div variants={itemVariants} className="inline-flex items-center gap-3 bg-primary/10 border border-primary/20 rounded-full py-1.5 px-4 text-primary text-sm font-bold tracking-wide">
            Enterprise Grade Deployment
          </motion.div>
          
          <motion.h1 variants={itemVariants} className="text-4xl font-extrabold tracking-tight text-foreground leading-[1.15]">
          ...
          <motion.p variants={itemVariants} className="text-lg text-muted-foreground leading-relaxed">
            Stop managing disjointed tools. Deploy your PulseTrack workspace and establish immediate operational superiority over internal workflows and client billing.
          </motion.p>
          ...
          <motion.div variants={containerVariants} className="flex flex-col gap-4 mt-2">
           ...
           <motion.div variants={itemVariants} className="mt-8 pt-8 border-t border-border w-full flex items-center gap-4">
             <div className="h-10 w-10 rounded-full border border-border bg-background overflow-hidden relative shrink-0">
               <img src="https://randomuser.me/api/portraits/women/44.jpg" alt="Sarah" className="object-cover w-full h-full" />
             </div>
             <div>
               <p className="text-sm font-medium italic text-foreground leading-relaxed">"We discarded three disparate tools immediately after initializing our PulseTrack workspace."</p>
               <p className="text-[10px] text-muted-foreground mt-1 font-bold tracking-wider">SARAH JOHNSON — OPERATIONS DIRECTOR</p>
             </div>
          </motion.div>
        </motion.div>
      </div>
      ...
      <div className="w-full lg:w-7/12 flex flex-col justify-center px-6 py-12 sm:px-16 xl:px-24 bg-background z-10 shadow-2xl lg:shadow-none min-h-screen overflow-y-auto">
        ...
        >
          ...
          <div className="flex flex-col mb-10 text-center lg:text-left items-center lg:items-start">
            <Link href="/" className="inline-flex items-center gap-3 group shrink-0 outline-none w-max mb-8">
              <motion.div whileHover={{ rotate: -10, scale: 1.05 }} className="h-10 w-10 bg-muted border border-border flex items-center justify-center rounded-xl shrink-0">
                 <Image src="/app-logo.png" alt="PulseTrack Logo" width={24} height={24} className="rounded" />
              </motion.div>
              <h2 className="text-xl font-bold tracking-tight text-foreground transition-colors">PulseTrack</h2>
            </Link>

            <h1 className="text-3xl font-extrabold tracking-tight text-foreground mb-2">Initialize Workspace</h1>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6 w-full">
            ...
            <div className="flex flex-col gap-2 relative">
              <Label htmlFor="companyName" className="text-sm font-semibold text-foreground">Organization Name</Label>
              <Input
                id="companyName"
                name="companyName"
                type="text"
                ...
                className="w-full text-foreground bg-background border border-border outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all rounded-lg px-4 py-5"
              />
              <p className="text-xs text-muted-foreground/80 font-medium">This generates your deterministic organizational slug structure.</p>
            </div>
            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="mt-5">
              <Button type="submit" disabled={isLoading} className="w-full bg-primary text-primary-foreground hover:bg-primary/90 h-14 rounded-xl text-base font-bold shadow-sm transition-all flex items-center justify-center gap-2">
                {isLoading ? (
                  <>
            ...
            <p className="text-xs text-muted-foreground/80 font-medium text-center md:text-left mt-2 leading-relaxed">
              By initializing your workspace, you accept our strict <Link href="/terms" className="text-primary hover:text-primary/80 transition-colors">Terms of Service</Link> and <Link href="/privacy" className="text-primary hover:text-primary/80 transition-colors">Data Protocol</Link>, designed specifically for enterprise security and operational compliance.
            </p>
          </form>
