        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-20 lg:mb-24">
          <motion.div variants={itemVariants} className="md:col-span-2">
            ...
            <p className="text-base text-muted-foreground max-w-sm mb-10 leading-relaxed">
              A meticulously engineered operating system for elite teams. Designed to eliminate
              friction and scale infinitely.
            </p>
        ...
        <motion.div
          ...
          <div className="flex flex-col gap-2 items-center md:items-start text-center md:text-left">
            ...
            <p className="text-xs text-muted-foreground/70">
              ...
              &mdash;{' '}
              <a
                href="mailto:angelo@zkidzdev.com"
                className="hover:text-foreground transition-colors">
                angelo@zkidzdev.com
              </a>
            </p>
