    ...
    <section className="relative overflow-hidden pt-32 pb-20 sm:pt-40 sm:pb-32 bg-background flex flex-col justify-center border-b border-border">
      ...
      <motion.div
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-3 rounded-full border border-primary/20 bg-primary/10 px-5 py-2 text-sm font-medium text-primary mb-10 shadow-sm transition-all duration-300 hover:bg-primary/20 cursor-default">
        ...
        <motion.p
          ...
          billing. Engineered for elite teams who prioritize performance.
        </motion.p>
