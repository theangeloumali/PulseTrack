      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group cursor-pointer outline-none">
            ...
            <span className="text-2xl font-bold tracking-tight text-foreground">PulseTrack</span>
          </Link>
          ...
          <div className="flex items-center gap-6 cursor-pointer">
            ...
            <Link
              ...
              <motion.span className="relative z-10 flex items-center gap-2" whileHover={{x: 3}}>
                Launch Workspace
                <svg
