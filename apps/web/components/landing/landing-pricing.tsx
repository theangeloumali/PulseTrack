...
const CheckIcon = ({ popular }: { popular?: boolean }) => (
  <div className={`flex-shrink-0 flex items-center justify-center w-5 h-5 rounded-full mr-3 ${popular ? 'bg-primary/20 text-primary' : 'bg-muted text-muted-foreground'}`}>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground">
            Predictable, scalable structures. No hidden fees. Select the configuration that matches your operational scale.
          </p>
        </motion.div>
        ...
        >
          {plans.map((plan) => (
            ...
            >
              ...
              <div className="mb-8">
                <h3 className="text-2xl font-bold text-card-foreground mb-2 tracking-tight">{plan.name}</h3>
              ...
              <div className="flex items-baseline mb-8 pb-8 border-b border-border">
                ...
                <span className="text-lg text-muted-foreground ml-1 font-medium">{plan.period}</span>
              </div>
