...
import { useActiveTimeEntry, useCreateTimeEntry, useUpdateTimeEntry } from '@/lib/hooks/useTimeTracking'
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <Input
                    ...
                    min="0"
                    value={manualHours}
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setManualHours(e.target.value)}
                    placeholder="0"
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    max="59"
                    value={manualMinutes}
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setManualMinutes(e.target.value)}
                    placeholder="0"
                  />
                </div>
              </div>
