...
export function SidebarLayout({ children }: SidebarLayoutProps) {
  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <div
        className={cn(
          "fixed inset-y-0 left-0 z-50 w-56 bg-sidebar shadow-lg transform transition-transform duration-200 ease-in-out lg:translate-x-0 lg:static lg:inset-0",
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="px-3 py-3 border-t border-sidebar-border">
            ...
            <Button
              variant="ghost"
              size="sm"
              className="w-full justify-start mt-2 text-destructive hover:text-destructive hover:bg-destructive-foreground/10"
