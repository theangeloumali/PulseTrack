...
export function SmartProgressTracker({
  ...
  const [selectedTab, setSelectedTab] = useState<'today' | 'week' | 'setup'>('today');
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">{tabData.subtitle}</p>
          </div>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between text-sm">
            <span className="text-muted-foreground">{tabData.completedText}</span>
