...
import { getBillingRatesByCompany, getCompanyBillingSettings, generateBillingReport } from '@/lib/db/billing-service';
...
export async function GET(req: NextRequest) {
    try {
        ...
        console.log('🔍 DEBUG: Starting billing debug for:', { companyId, startDate, endDate });
        ...
        return NextResponse.json({
            ...
            debug: {
                ...
                reportSample: Object.keys(report || {}).slice(0, 2).reduce((acc, date) => {
