...
export default function CompanyDetailsPage() {
  ...
  const roleColors = {
    ...
    company_admin: 'bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-400',
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <div className="text-xs font-mono text-muted-foreground">{company.id}</div>
          ...
          <div className="bg-card rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-foreground">{company.stats.users.total}</p>
                <p className="text-xs text-muted-foreground">{company.stats.users.active} active</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-card rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-foreground">{company.stats.projects.total}</p>
                <p className="text-xs text-muted-foreground">{company.stats.projects.active} active</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-card rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-foreground">{company.stats.tickets.total}</p>
                <p className="text-xs text-muted-foreground">{company.stats.tickets.inProgress} in progress</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-card rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-foreground">{company.stats.users.admins}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="bg-card rounded-lg shadow p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-foreground">{new Date(company.created_at).toLocaleDateString('en-US', {
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric'
                })}</p>
              ...
              <div>
                ...
                <p className="text-foreground">{new Date(company.updated_at).toLocaleDateString('en-US', {
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric'
                })}</p>
          ...
          <div className="bg-card rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm text-muted-foreground">System Admins</span>
                <span className="text-sm font-medium text-foreground">
                  {companyUsers.filter(u => u.role === 'system_admin').length}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-muted-foreground">Company Admins</span>
                <span className="text-sm font-medium text-foreground">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-medium text-foreground">{userStats.managers}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-muted-foreground">Users</span>
                <span className="text-sm font-medium text-foreground">{userStats.users}</span>
              </div>
              <div className="pt-2 border-t border-border">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium text-muted-foreground">Total</span>
                  <span className="text-sm font-bold text-foreground">{userStats.total}</span>
                </div>
              </div>
            </div>
          </div>
