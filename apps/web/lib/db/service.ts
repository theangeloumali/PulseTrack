 ...
 */
export async function getAccessibleTicketsByCompany(
  companyId: string,
  userId: string,
  userRole: string,
) {
...
export async function getTotalTimeByUser(
  userId: string,
  dateFrom?: string,
  dateTo?: string,
): Promise<number> {
 ...
 */
export async function getAccessibleProjectsByCompany(
  companyId: string,
  userId: string,
  userRole: string,
) {
 ...
 * - Regular users (user, manager): See only projects they are explicitly assigned to as members
 */
export async function getAccessibleProjectsWithTicketCounts(
  companyId: string,
  userId: string,
  userRole: string,
) {
 ...
 */
export async function canUserManageProjectMembers(
  userId: string,
  projectId: string,
): Promise<boolean> {
 ...
 */
export async function getTimeEntriesForBilling(
  companyId: string,
  startDate: string,
  endDate: string,
) {
 ...
 * Log user added to project activity
 */
export async function logUserAddedToProject(
  projectId: string,
  userId: string,
  targetUserId: string,
  projectName: string,
 ...
 * Log user removed from project activity
 */
export async function logUserRemovedFromProject(
  projectId: string,
  userId: string,
  targetUserId: string,
  projectName: string,
 ...
 * Log time entry creation activity
 */
export async function logTimeEntryCreated(
  projectId: string,
  ticketId: string,
  userId: string,
  duration: number,
