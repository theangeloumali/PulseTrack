        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-xl text-gray-600 mt-6 leading-relaxed">
              Streamline your workflow with PulseTrack's integrated ticketing, time tracking, and billing system. 
              Perfect for agencies, freelancers, and teams who need to track billable hours and deliver professional reports.
            </p>
